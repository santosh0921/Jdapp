...
class _CustomerShellState extends State<CustomerShell> {
  ...
  static const _items = [
    ...
    JdNavItem(icon: Icons.inventory_2_outlined, activeIcon: Icons.inventory_2_rounded, label: 'Orders'),
    JdNavItem(icon: Icons.location_on_outlined, activeIcon: Icons.location_on_rounded, label: 'Track'),
    JdNavItem(icon: Icons.payment_outlined, activeIcon: Icons.payment_rounded, label: 'Pay'),
